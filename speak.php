...
$noDatabase = true;
if (isset($_SERVER['DB1_HOST']) && isset($_SERVER['DB1_PORT']) && isset($_SERVER['DB1_USER']) && isset($_SERVER['DB1_PASS']) && isset($_SERVER['DB1_NAME'])) {
  $con = mysql_connect($_SERVER['DB1_HOST'].':'.$_SERVER['DB1_PORT'], $_SERVER['DB1_USER'], $_SERVER['DB1_PASS']);
  if (!$con) {
    $noDatabase = true;
